...
public class Otptry extends AppCompatActivity {
    ...
    private void signInTheUserByCredentials(PhoneAuthCredential credential) {
        ...
        firebaseAuth.signInWithCredential(credential)
                .addOnCompleteListener(Otptry.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(Otptry.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
